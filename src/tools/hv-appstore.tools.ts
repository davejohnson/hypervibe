...
const SETUP_HINT =
  'Create an App Store Connect API key at https://appstoreconnect.apple.com/access/api (Admin role; the .p8 file can only be downloaded once), then store it with hv_connect/connection_create provider=appstoreconnect credentials={"keyId","issuerId","privateKey"}. ' +
